...
| 4 | uint32 | Number of values (n)
| 8 | n * Tag data or uint32 offset | Tag data (if the size of n * Tag data is lower or equal to 32 bits) or offset to tag data (otherwise)
|===
