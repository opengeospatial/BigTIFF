:Title: OGC BigTIFF community standard
:titletext: {Title}
:doctype: book
:encoding: utf-8
:lang: en
...
|Internal reference number of this OGC(R) document:    21-061
|Version: n.n
|Category: OGC(R) <Implementation Standard / Abstract Specification / Best Practice>
|Editor:   Joan Maso
|===
